...
export default function Home() {
  return (
    <main>
<a href="/Answer1">Describe how you solved a challenge that one of your previous teams faced.
How did you determine your solution was successful?
</a>
<br/> <br/>
<a href="/Answer2">How would you compare Next.js with another framework? Feel free to compare
with a framework of your choice.
</a>  
<br/> <br/>
<a href="/Answer3">A customer has reached out asking, “When should I choose to use Edge
Functions, Serverless Functions, or Edge Middleware with Vercel?” Write a reply
to the customer.
</a>
<br/> <br/>
<a href="/Answer4">A customer has a project on Vercel and they want to redirect the /blog path to
another website. Write a reply to the customer.
</a>
<br/> <br/>
<a href="/Answer5">Imagine that the customer from Question 4 responds with the following email.
...
<br/> <br/>
<a href="/Answer6">A customer is just getting started with Vercel and has questions about
...
<br/> <br/>
<a href="/Answer7">A customer, new to Next.js and Vercel, asks about overages regarding serverless
...
<br/> <br/>
<a href="/Answer8">How could we improve or alter this familiarization exercise?
</a>
</main>  
  );
}
